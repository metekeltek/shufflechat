...
class FilterIntrests extends StatefulWidget {
  @override
  _FilterIntrestsState createState() => _FilterIntrestsState();
}

class _FilterIntrestsState extends State<FilterIntrests> {
