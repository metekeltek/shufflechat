...
class CustomCheckBoxFixed<T> extends StatefulWidget {
  CustomCheckBoxFixed({
    Key key,
  ...
  _CustomCheckBoxFixedState createState() => _CustomCheckBoxFixedState();
}

class _CustomCheckBoxFixedState extends State<CustomCheckBoxFixed> {
