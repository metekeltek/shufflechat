...
class CustomRadioButtonFixed<T> extends StatefulWidget {
  CustomRadioButtonFixed({
    this.buttonLables,
    this.buttonValues,
  ...
  _CustomRadioButtonFixedState createState() => _CustomRadioButtonFixedState();
}

class _CustomRadioButtonFixedState extends State<CustomRadioButtonFixed> {
